...
//  is there some kind of library for this? add all back to non-P
...
function astToJsStructure(ast){
  ...
  else if (ast[0] == "repeat") {
    //console.log(ast[1]);
    return "(" + astToJsStructure(ast[1]) + ").repeat(" + ast[2] + ")";
  }
  else {
...
var astToJs = function astToJs(ast) {
