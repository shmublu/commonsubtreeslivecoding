...
//variables used to generate loops and plug their variables in
var numberOfLoops = 0;
var loopStorage = []
...
function astToJsStructure(ast){
  ...
  if( typeof ast == "string" || typeof ast == "number") {
    ...
    //console.log(ast[1]);
    var loopResultVarName = "innerVariable" + (++numberOfLoops).toString();
    loopStorer(ast);
    return loopResultVarName;
  }
  else {
...
function loopStorer(repeatAST) {
  loopStorage.push(repeatAST);
}

var astToJs = function astToJs(ast) {
  var x = "return " + astToJsStructure(ast) + ";";
  return x;
};
